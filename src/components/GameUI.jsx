...
import { Atom, Zap, Circle, Trophy } from "lucide-react";

export default function GameUI({ stats, currentPlayerId }) {
  ...
  // Sort players by protons descending and take top 10
    ...
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
      ...
      <div className="absolute top-6 right-6 bg-gray-900/90 border-2 border-blue-500/50 rounded-lg p-4 backdrop-blur-sm pointer-events-auto max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-1 text-xs text-gray-300 mb-4">
          ...
          <div>
            <span className="text-blue-400 font-mono">Left Click</span> - Shoot
          </div>
        </div>
      ...
      {/* Mini-Map */}
      <div className="absolute bottom-6 right-6 w-[210px] h-[210px] bg-gray-a900/90 border-2 border-blue-500/50 rounded-lg p-2 backdrop-blur-sm pointer-events-auto">
